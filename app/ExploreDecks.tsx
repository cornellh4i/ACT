...
const ExploreDecks: React.FC = () => {
  const decks = [
    ...
    { id: 'platforms_medium', category: 'platforms_and_privacy', difficulty: 'medium', progress: 0.0 },
    ...
    { id: 'inappropriate_easy', category: 'inappropriate_content', difficulty: 'easy', progress: 0.0 },
    { id: 'inappropriate_medium', category: 'inappropriate_content', difficulty: 'medium', progress: 0.0 },
    { id: 'inappropriate_hard', category: 'inappropriate_content', difficulty: 'hard', progress: 0.0 },

    { id: 'social_easy', category: 'social_media_and_mental_health', difficulty: 'easy', progress: 0.0 },
    { id: 'social_medium', category: 'social_media_and_mental_health', difficulty: 'medium', progress: 0.0 },
    { id: 'social_hard', category: 'social_media_and_mental_health', difficulty: 'hard', progress: 0.0 },
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F0F0F2]">
      <View className="flex-row items-center justify-between px-4 py-3">
        ...
        <Text style={{ position: 'absolute', left: 0, right: 0, textAlign: 'center' }} className="text-xl font-jost-bold">
          Explore Decks
        </Text>
        ...
        renderItem={({ item, index }) => {
          ...
          return (
            <View
              ...
              className="px-2"
            >
              <DeckCard catagory={item.category as any} difficulty={item.difficulty as any} progress={item.progress} />
            </View>
          );
        }}
      />
