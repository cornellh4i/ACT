  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        goldplay: ['Goldplay-Regular', 'system-ui', 'sans-serif'],
        'goldplay-semibold': ['Goldplay-SemiBold', 'Goldplay-Regular', 'sans-serif'],
        'goldplay-bold': ['Goldplay-Bold', 'Goldplay-Regular', 'sans-serif'],
      },
    },
  },
  plugins: [],
